...
<div style="text-align: justify">The Kappa Coefficient, commonly referred to as `Cohen's Kappa Score`, is a statistic used to assess the effectiveness of machine learning classification models. Its formula, which is based on the conventional 2x2 confusion matrix, is used to assess binary classifiers in statistics and machine learning. Jacob Cohen, a statistician who developed `Cohen's Kappa Coefficient` in 1960, is the name of the measure. 
